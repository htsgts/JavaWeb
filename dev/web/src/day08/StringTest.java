...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		// 1. length()
		String str1 = "asfajsfnaskdfjnaskfsaf";
		...
		String str8 = "help";
		Mu.p("[replace()] " + str7.replace(str8,"_____"));
...
//		Mu.p("[substring()] : " + str12);
		...
		String rule = "[0]{1}[1]{1}[0-9]{1}[-][0-9]{3,4}[-][0-9]{4}";
